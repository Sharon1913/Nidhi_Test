...
<body>
        ...
        <header class="dashboard-header">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="superadmin_assign_task.php?project_id=<?= $project_id ?>" class="btn btn-primary">
                ...
                <div class="users-grid">
                            ...
                            <div class="user-card" onclick="viewUserTasks(<?= $user['id'] ?>, <?= $project_id ?>)">
                                ...
                                <div class="user-actions">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn-remove" onclick="event.stopPropagation(); if(confirm('Are you sure you want to remove this member from the project?')) window.location.href='superadmin_project_details.php?id=<?= $project_id ?>&remove_user=<?= $user['employee_id'] ?>&project_id=<?= $project_id ?>'">
                    ...
                    <?php else: ?>
                        <div class="empty-state">
                            ...
                            <a href="superadmin_assign_user.php?project_id=<?= $project_id ?>" class="btn btn-primary">
                                Assign Team Members
                            </a>
                        </div>
                    <?php endif; ?>
    ...
    <script>
        function viewUserTasks(employee_id, project_id) {
            window.location.href = `superadmin_user_tasks.php?user_id=${employee_id}&project_id=${project_id}`;
        }
